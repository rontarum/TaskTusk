...
import { TableRowCompletionAnimation } from "./TableRowCompletionAnimation";
                ...
                {ordered.map((it) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="relative border-b border-buttonOutline/50 last:border-b-0"
                      style={{ transformStyle: "preserve-3d", z: 40 }}
                    >
                      {isCompleting && (
                        <TableRowCompletionAnimation
                          item={it}
                          isVisible={true}
                      ...
                      <div className="px-5 py-4" style={{ transformStyle: "preserve-3d" }}>
                        {rowContent}
                      </div>
                    </motion.div>
                  );
